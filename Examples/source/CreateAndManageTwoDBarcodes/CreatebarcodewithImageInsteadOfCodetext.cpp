		...
		namespace Examples {
			...
			namespace CSharp {
				...
				namespace CreateAndManageTwoDBarcodes {
					...
					RTTI_INFO_IMPL_HASH(973485823u, ::Aspose::BarCode::Examples::CSharp::CreateAndManageTwoDBarcodes::CreatebarcodewithImageInsteadOfCodetext, ThisTypeBaseTypesInfo);
					...
					void CreatebarcodewithImageInsteadOfCodetext::Run()
					{
						...
						{
							System::SharedPtr<BarcodeGenerator> generator = System::MakeObject<BarcodeGenerator>(Aspose::BarCode::Generation::EncodeTypes::EAN13, u"123456789012");
							// Clearing resources under 'using' statement
							System::Details::DisposeGuard<1> __dispose_guard_4({ generator });
							// ------------------------------------------
							...
							try
							{
								// Generate Barcode image and store it in a Bitmap
								{
									...
									try
									{
										...
										{
											System::SharedPtr<System::Drawing::Bitmap> picture = System::DynamicCast<System::Drawing::Bitmap>(System::Drawing::Image::FromFile(dataDir + u"path_to_your_picture.png"));
											// Clearing resources under 'using' statement
											...
											try
											{
												// Create a new empty image with new Calculated height &amp; width
												{
													...
													try
													{
														...
														output->Save(dataDir + u"output.jpg");
													}
													catch (...)
													{
