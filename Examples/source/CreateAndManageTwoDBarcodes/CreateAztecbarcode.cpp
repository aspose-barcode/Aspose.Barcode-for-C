...
void CreateAztecbarcode::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> barCodeBuilder = System::MakeObject<BarCodeBuilder>(u"123456789", EncodeTypes::Aztec);
    barCodeBuilder->Save(dataDir + u"CreateAztecbarcode_out.bmp", Aspose::BarCode::BarCodeImageFormat::Bmp);
