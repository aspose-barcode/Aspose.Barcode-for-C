...
void CreateSimpleDatamatrixBarCode::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> barCodeBuilder = System::MakeObject<BarCodeBuilder>(u"123456789", EncodeTypes::DataMatrix);
    
    // Width of each module and Save the Barcode image
    barCodeBuilder->set_xDimension(0.6f);
    barCodeBuilder->Save(dataDir + u"Datamatrixbarcode_out.bmp", Aspose::BarCode::BarCodeImageFormat::Bmp);
