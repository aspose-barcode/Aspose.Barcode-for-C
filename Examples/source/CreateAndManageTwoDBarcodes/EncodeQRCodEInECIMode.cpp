			...
			namespace CSharp {
				...
				namespace CreateAndManageTwoDBarcodes {
					...
					void EncodeQRCodEInECIMode::Run()
					{
						...
						generator->get_Parameters()->get_Barcode()->get_QR()->set_QrEncodeMode(Aspose::BarCode::QREncodeMode::ECIEncoding);
						generator->get_Parameters()->get_Barcode()->get_QR()->set_QrEncodeType(Aspose::BarCode::QREncodeType::ForceQR);
						generator->get_Parameters()->get_Barcode()->get_QR()->set_QrECIEncoding(Aspose::BarCode::ECIEncodings::UTF8);
						...
						System::Console::WriteLine(System::Environment::get_NewLine() + u"Barcode saved at " + dataDir + u"EncodeQRCodEInECIMode_out.bmp");
