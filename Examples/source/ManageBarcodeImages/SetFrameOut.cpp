...
void SetFrameOut::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> barCodeBuilder = [&]{ auto tmp_0 = System::MakeObject<BarCodeBuilder>(u"00850006000227", EncodeTypes::ITF14); tmp_0->set_AutoSize(true); tmp_0->set_ITF14BorderType(Aspose::BarCode::ITF14BorderType::FrameOut); tmp_0->set_CodeTextFont(System::MakeObject<System::Drawing::Font>(u"OCR B Std", 8.0f)); tmp_0->set_GraphicsUnit(System::Drawing::GraphicsUnit::Millimeter); tmp_0->set_xDimension(0.495f); tmp_0->set_BarHeight(12.7f); tmp_0->set_CodeTextSpace(0.5f); tmp_0->set_Resolution(System::MakeObject<Resolution>(1200.0f, 1200.0f, Aspose::BarCode::ResolutionMode::Customized)); return tmp_0; }();
    barCodeBuilder->Save(dataDir + u"ITF14_Border_Type_FrameOut_out.png", Aspose::BarCode::BarCodeImageFormat::Png);
    // ExEnd:SetFrameOut                       
}
