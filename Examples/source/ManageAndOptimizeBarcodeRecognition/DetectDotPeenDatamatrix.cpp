				...
				namespace ManageAndOptimizeBarCodeRecognition {
					...
					void DetectDotPeenDatamatrix::Run()
					{
						try
						{
							...
							{
								System::SharedPtr<BarCodeReader> reader = System::MakeObject<BarCodeReader>(dataDir + u"testDotPeen.jpg", DecodeType::DataMatrix);
								...
								try
								{
									...
									reader->get_QualitySettings()->set_AllowDatamatrixIndustrialBarcodes(true);
									while (reader->Read())
									{
