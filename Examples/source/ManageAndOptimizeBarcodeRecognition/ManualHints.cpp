...
void ManualHints::Run()
{
    try
    {
        ...
        {
            System::SharedPtr<BarCodeReader> reader = System::MakeObject<BarCodeReader>(dataDir + u"SymbologyTypebarcode.png", DecodeType::Code128);
            ...
            try
            {
                ...
                reader->set_ManualHints(Aspose::BarCode::BarCodeRecognition::ManualHint::MedianSmoothing);
                while (reader->Read())
                {
