...
#include <BarCodeRecognition/Recognition/RecognitionFilters/DecodeTypes/MultyDecodeType.h>
...
void GetAllPossible1DBarcodesfromImage::Run()
{
    try
    {
        ...
        reader->set_RecognitionMode(Aspose::BarCode::BarCodeRecognition::RecognitionMode::MaxBarCodes);
        
        while (reader->Read())
        {
            // Display code text, symbology, detected angle, recognition percentage of the barcode
            System::Console::WriteLine(System::String(u"Code Text: ") + reader->GetCodeText() + u" Symbology: " + reader->GetCodeType() + u" Recognition percentage: " + reader->GetAngle());
