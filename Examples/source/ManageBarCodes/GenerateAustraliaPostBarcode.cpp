...
void GenerateAustraliaPostBarcode::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> builder = System::MakeObject<BarCodeBuilder>(codeText, EncodeTypes::AustraliaPost);
    
    // Set format control code to standard
    builder->Save(dataDir + u"AustraliaPost-Standard_out.png");
}
