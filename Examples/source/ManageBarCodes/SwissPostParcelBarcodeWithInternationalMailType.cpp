...
void SwissPostParcelBarcodeWithInternationalMailType::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> builder = System::MakeObject<BarCodeBuilder>(u"RA121212122CH", EncodeTypes::SwissPostParcel);
    builder->Save(dataDir + u"SwissPostParcelBarcodeWithInternationalMailType_out.png");
