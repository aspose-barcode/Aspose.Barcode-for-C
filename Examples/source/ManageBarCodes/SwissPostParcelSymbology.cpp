			...
			namespace CSharp {
				...
				namespace ManageBarCodes {
					...
					void SwissPostParcelSymbology::Run()
					{
						...
						System::SharedPtr<BarcodeGenerator> generator = System::MakeObject<BarcodeGenerator>(EncodeTypes::SwissPostParcel, u"0610");
						generator->Save(dataDir + u"SwissPostParcelSymbology_out.png");
