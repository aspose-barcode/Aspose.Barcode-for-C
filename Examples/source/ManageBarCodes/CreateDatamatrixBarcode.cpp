...
void CreateDatamatrixBarcode::Run()
{
    ...
    System::SharedPtr<BarCodeBuilder> barCodeBuilder = System::MakeObject<BarCodeBuilder>(u"1234567890", EncodeTypes::DataMatrix);
    barCodeBuilder->Save(dataDir + u"datamatrix-barcode_out.jpg", Aspose::BarCode::BarCodeImageFormat::Jpeg);
