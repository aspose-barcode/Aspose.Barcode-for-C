			...
			namespace CSharp {
				...
				namespace ManageBarCodes {
					...
					void CreateCouponExtendedBarcode::Run()
					{
						...
						System::SharedPtr<BarcodeGenerator> generator = System::MakeObject<BarcodeGenerator>(EncodeTypes::UpcaGs1Code128Coupon, u"514141100906(8102)03");
						generator->Save(dataDir + u"UpcaGs1Code128Coupon_out.png");
