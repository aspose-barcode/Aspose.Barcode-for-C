			...
			namespace CSharp {
				...
				namespace ManageBarCodes {
					...
					void SwissPostParcelBarcodeWithAdditionalServiceType::Run()
					{
						...
						System::SharedPtr<BarcodeGenerator> generator = System::MakeObject<BarcodeGenerator>(EncodeTypes::SwissPostParcel, u"989967121212121212");

						generator->Save(dataDir + u"SwissPostParcelBarcodeWithAdditionalServiceType_out.Png");
