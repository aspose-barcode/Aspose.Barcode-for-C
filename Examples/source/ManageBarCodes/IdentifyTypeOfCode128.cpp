...
#include <BarCodeRecognition/Recognition/OneD/MetaDecoder/Code128/Code128SubType.h>
#include <BarCodeRecognition/Recognition/OneD/MetaDecoder/Code128/Code128DataPortion.h>
						...
						// Set the recognition type
						{
							...
							try
							{
								...
								if (reader->Read())
								{
									...
									System::Console::WriteLine(u"Execute Loop for each Code128DataPortion instance");
