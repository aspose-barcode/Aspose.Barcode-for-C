...
void GenerateAndRecognizeUTF8Characters::Run()
{
    try
    {
        ...
        System::SharedPtr<BarCodeBuilder> objBarCodeBuilder = [&]{ auto tmp_0 = System::MakeObject<BarCodeBuilder>(); tmp_0->set_EncodeType(EncodeTypes::MacroPdf417); return tmp_0; }();
        
        // Set the codetext by converting it into unicode byte array
        System::ArrayPtr<uint8_t> byteArray = System::Text::Encoding::get_Unicode()->GetBytes(u"منحة");
