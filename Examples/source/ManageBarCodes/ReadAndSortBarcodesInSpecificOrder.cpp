...
System::Object::shared_members_type Aspose::BarCode::Examples::CSharp::ManageBarCodes::ReadAndSortBarcodesInSpecificOrder::FoundBarCodes::GetSharedMembers()
{
    auto result = System::Object::GetSharedMembers();
    
    result.Add("Aspose::BarCode::Examples::CSharp::ManageBarCodes::ReadAndSortBarcodesInSpecificOrder::FoundBarCodes::region", this->region);
